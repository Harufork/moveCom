    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='Введите наименование вида (прим. Грузовик 14 т.)', max_length=255, verbose_name='Наименование вида')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aviable', models.BooleanField(default=False, help_text='Выберите доступен ли транспорт сейчас (прим. он может быть в автомастерской)', verbose_name='Активно')),
